...
def get_data_from_csv(file):
    ...
    # convert to float       
        try:
            ...
            send_message_to_queue(host, smoker_queue, smoker_message)
        except ValueError:
            pass
        ...
        try:
            ...
            send_message_to_queue(host, food_a_queue, food_a_message)
        except ValueError:
            pass
        ...
        try:
            ...
            send_message_to_queue(host, food_b_queue, food_b_message)
        except ValueError:
           pass
